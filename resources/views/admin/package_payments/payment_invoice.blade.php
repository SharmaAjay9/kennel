                        ...
                        <div class="col-sm-12">
                            <div class="row gutters-5">
                                ...
                                <div class="col-md-7 text-right">
                                    <h3>{{ translate('Order ID')}} : {{ $payment->order_id }}</h3>
                                </div>
                            </div>
                            <hr>
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <strong>{{ translate('Billed To,') }}</strong><br>
                                  ...
                                  <b>{{ translate('Name:') }}</b> {{$payment->name}}
                                  <br>
                                  <b>{{ translate('Email:') }}</b> {{$payment->email}}
                                  <br>
                                  <b>{{ translate('Phone:')}}</b> {{$payment->mobile}}
                        ...
                        <h5><b>{{translate('Purchase Summary')}}</b></h5>
                    		<div class="card">
                    			<div class="card-body">
                                  ...
                                  <tr>
                                  <td>
                                    Payment Type : {{ translate($payment->type)}}
                                  </td>
